...
import { MapPin, CheckCircle2, Map, ArrowRight } from "lucide-react";
...
export function Coverage() {
  return (
    <>
      {/* Coverage header — dark gradient image background (highlighted area only) */}
      <section className="relative isolate overflow-hidden bg-primary text-white">
        <div className="absolute inset-0 -z-10">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to right, rgba(2,6,23,0.94) 0%, rgba(15,23,42,0.88) 45%, rgba(15,23,42,0.78) 100%)",
            }}
          />
        </div>
      ...
      {/* Regions — detached, light background */}
